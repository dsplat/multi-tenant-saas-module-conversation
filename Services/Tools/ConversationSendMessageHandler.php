...
class ConversationSendMessageHandler implements ToolHandlerContract
{
    public function __construct(private readonly ConversationService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->sendMessage((int) $arguments['conversation_id'], $arguments['content'], $arguments['type'] ?? null);
    }
}
