...
class ConversationCreateHandler implements ToolHandlerContract
{
    public function __construct(private readonly ConversationService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->createConversation($arguments['title'], $arguments['type'] ?? null, $arguments['participant_ids'] ?? []);
    }
}
